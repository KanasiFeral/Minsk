<!DOCTYPE html>  
	...
	<HEAD>
	    ...
	    <style type="text/css">
            ...
            #deat_deat
            {
                background-image: url(../Buttons/DeatOff.png);
            }
            #deat_deat:hover
            {
                background-image: url(../Buttons/DeatOn.png);                
            }
		...
		<BODY>
            ...
            <div id="main">
                ...
                <div id="secondMenu" align="center">                    
                    ...
                    <a href="#deat">
                        <div class="menu_s" id="deat_deat"></div>
                    </a>
                </div>
                <div align="center" class="main_m">
                    <a name="Arens">Академия наук</a>                  
                </div>        
                        <div class="left_inf" align="center">                        
                        <img src="../Images/Science/Akademia-Nauck.jpg" class="img_s">
                        <a name="opis"><b>Национальная академия наук Беларуси</b></a>
                        <p class="text_m">
                            <?php
								$queryScience = mysql_query("SELECT * FROM Science WHERE id_Science = 1");
								while($Science = mysql_fetch_array($queryScience))
								{
									print $Science['Opisanie'] .'<br>';
								}
							?>
                        </p>
                        <div id="gallery1" align="center">
						    <!-- Первый ряд картинок -->
							<a><img src="../Images/Science/Akademia-Nauck(1).JPG" tabindex="1" title="Академия наук" alt="Академия наук">
							<a><img src="../Images/Science/Akademia-Nauck(2).jpg" tabindex="1"  title="Старые фото" alt="Старые фото"></a>
							<a><img src="../Images/Science/Akademia-Nauck(3).jpg" tabindex="1"  title="Вид сбоку" alt="Вид сбоку"></a> 
						</div>
                        <p class="text_m">
                            <center><a name="his"><b>История</b></a><br></center>
                            <?php
								$queryScience = mysql_query("SELECT * FROM Science WHERE id_Science = 2");
								while($Science = mysql_fetch_array($queryScience))
								{
									print $Science['Opisanie'] .'<br>';
								}
                        ...
                        <div id="gallery1" align="center">
						    <!-- Второй ряд картинок -->
							<a><img src="../Images/Science/Akademia-Nauck(4).JPG" tabindex="1" title="Старые фото" alt="Старые фото">
							<a><img src="../Images/Science/Akademia-Nauck(5).jpg" tabindex="1"  title="Старые фото" alt="Старые фото"></a>
							<a><img src="../Images/Science/Akademia-Nauck(6).jpg" tabindex="1"  title="Фассад здания" alt="Фассад здания"></a> 
						</div>
                        <p class="text_m">
                            <center><a name="deat"><b>Деятельность</b></a><br></center>
                            <?php
								$queryScience = mysql_query("SELECT * FROM Science WHERE id_Science = 3");
								while($Science = mysql_fetch_array($queryScience))
								{
									print $Science['Opisanie'] .'<br>';
								}
                    ...
                    <div class="right_inf" align="center">
                       <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d4699.189145610254!2d27.597747!3d53.921180000000014!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1c42fc4cbe826350!2z0JDQutCw0LTQtdC80LjRjyDQvdCw0YPQug!5e0!3m2!1sru!2s!4v1416214800810" width="100%" height="300px" frameborder="0" style="border:0">Ваш браузер не поддерживает плавающие фреймы!Или отсутствует соединение интернет!</iframe>
                    </div>    
                <div id="footer"></div>
            </div>
            <div id="clock">
